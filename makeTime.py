...
cdate_dic = {}
for date in list(confirmed_date): # 날짜 별 확진된 사람 수
...
rdate_dic = {}
for date in list(released_date): # 날짜 별 완치된 사람 수
...
ddate_dic = {}
for date in list(deceased_date): # 날짜 별 사망자 수
...
date = []
total_confirmed = 0 # 총 확인된 감염자 수
total_released = 0 # 총 완치된
total_deceased = 0 # 총 사망자
