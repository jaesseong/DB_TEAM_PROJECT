...
with open("K_COVID19.csv", 'r') as file:
    ...
    for i, line in enumerate(file_read):
        ...
        print(sql_data)
        query = """INSERT INTO `patientInfo`(patient_id,sex,age,country,province,city,infection_case,infected_by,
        contact_number,symptom_onset_date,confirmed_date,released_date,deceased_date,state) VALUES (%s,%s,%s,%s,%s,
        %s,%s,%s,%s,%s,%s,%s,%s,%s)"""
