...
<body>
    <h1 style="text-align:center"> Hospital Search </h1>
	...
	<input type="hidden" name="action" value="form_submit" />
        Put Hospital Id : <input name="patient_id">
        </input>
    ...
    <?php
        if($current_search != NULL) {
            $sql = "select count(*) as num from patientinfo where hospital_id=\"".$current_search."\"";
    ...
    <table cellspacing="0" width="100%">
        ...
        <tbody>
            <?php
                ...
                $sql = "select * from patientinfo where hospital_id=\"".$current_search."\"";
                ...
                while( $row = mysqli_fetch_assoc($result)  )
                {
                    ...
                    foreach($row as $key => $val)
                    {
                        ...
                        { 
                            ...
                            print "<td><a href='search_hospital_id_with_map.php?hospital_id=".$val."'>".$val."</a></td>";
                        }
                    }
                    print "</tr>";
                }
